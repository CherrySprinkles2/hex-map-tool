...
const TerrainPatterns = () => (
  <defs>
    ...
    <pattern id="pattern-grass" x="0" y="0" width="14" height="14" patternUnits="userSpaceOnUse">
      <line x1="2"  y1="11" x2="4"  y2="6"  stroke="rgba(0,80,0,0.28)"  strokeWidth="1.2" strokeLinecap="round" />
      <line x1="4"  y1="11" x2="6"  y2="7"  stroke="rgba(0,80,0,0.18)"  strokeWidth="1"   strokeLinecap="round" />
      <line x1="9"  y1="11" x2="11" y2="6"  stroke="rgba(0,80,0,0.28)"  strokeWidth="1.2" strokeLinecap="round" />
      <line x1="11" y1="11" x2="13" y2="7"  stroke="rgba(0,80,0,0.18)"  strokeWidth="1"   strokeLinecap="round" />
      <line x1="5"  y1="5"  x2="7"  y2="1"  stroke="rgba(0,80,0,0.15)"  strokeWidth="1"   strokeLinecap="round" />
    </pattern>
    ...
    <pattern id="pattern-lake" x="0" y="0" width="30" height="10" patternUnits="userSpaceOnUse">
      <path
        ...
        stroke="rgba(255,255,255,0.22)" strokeWidth="1.4" fill="none" strokeLinecap="round"
      />
      <path
    ...
    <pattern id="pattern-ocean" x="0" y="0" width="50" height="18" patternUnits="userSpaceOnUse">
      <path
        ...
        stroke="rgba(255,255,255,0.18)" strokeWidth="1.8" fill="none" strokeLinecap="round"
      />
      <path
        d="M0,12 C7,9 14,15 21,12 C28,9 35,15 42,12 C45,10.5 47.5,9.5 50,12"
        stroke="rgba(255,255,255,0.10)" strokeWidth="1.2" fill="none" strokeLinecap="round"
      />
    </pattern>
  </defs>
);
